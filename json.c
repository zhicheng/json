...
int
json_parse_true(json_parser_t *parser,
                json_value_t *super, json_value_t *value)
{
	int i;
	int c;
	int s;
...
int
json_parse_false(json_parser_t *parser,
                 json_value_t *super, json_value_t *value)
{
	int i;
	int c;
...
int
json_parse(json_parser_t *parser, json_value_t *super, json_value_t *value)
{
	int i;
	int c;
...
json_parser_parse(json_parser_t *parser,
                  json_value_t *super, char *buf, int len)
{
	parser->off = 0;
	parser->len = len;
	parser->buf = buf;
...
int
json_parser_value(json_parser_t *parser,
                  json_value_t *super, json_value_t *value)
{
	int i;
	int c;
...
int
json_parser_pair(json_parser_t *parser,
                 json_value_t *super, json_value_t *name, json_value_t *value)
{
	int i;
	int c;
	int s;
...
int
json_parser_ignore(json_parser_t *parser, json_value_t *value)
{
	int i;
	int c;
	int s;
